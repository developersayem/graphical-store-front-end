        ...
        <div className='container mx-auto p-4 my-6 space-y-2 text-center'>
            <section className="w-full px-6 py-4 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                ...
                <div className="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
                    <Link href="#" className="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-300 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500">
                    ...
                    <Link href="#" className="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-300 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500">
                        ...
                        <span classNem="mt-2">+8801xxxxxxxxx</span>
                    </Link>
