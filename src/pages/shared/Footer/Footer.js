        ...
        <div>
            <footer class="bg-white dark:bg-gray-900">
                <div class="container p-6 mx-auto">
                        ...
                        <div class="mt-6 lg:mt-0 lg:flex-1">
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                <div>
                                    ...
                                    <Link href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Services</Link>
                                    <Link href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">community</Link>
                                    <Link href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Products</Link>
                                </div>

                                <div>
                                    <h3 class="text-gray-700 uppercase dark:text-white">Products</h3>
                                    <Link href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Logo Design</Link>
                                    <Link href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Poster Desing</Link>
                                    <Link href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Banner Design</Link>
                                </div>
                    ...
                    <div>
                        <p class="text-center text-gray-500 dark:text-gray-400">© Graphical Store 2020 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </div>
